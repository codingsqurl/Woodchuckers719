...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'Mi Trabajo | Woodchuckers Escalador de Árboles por Contrato',
    description: 'Escaladas reales, resultados reales. Escalada por contrato en Colorado Springs para empresas de árboles.',
    url: '/es/portfolio',
    images: ['/img/og.jpg'],
  },
