...
const en = {
  ...
  contract: {
    ...
    metaDesc:
      'Need a climber for a section your crew can’t reach? I climb contract in Colorado Springs — sectional removals, storm work, rigging-heavy takedowns. Insured, own gear.',
    kicker: 'For tree companies',
    headTitle: 'I climb contract',
    headLede:
      'Your crew, my ropes. Book me for the section nobody on the ground wants — sectional takedowns, storm-blown leaders, rigging over the house.',
    bookLine: 'Call or text to book a day:',
    ratesTitle: 'Day rates',
    tierHalf: 'Half day',
    tierHalfNote: 'Up to ~4 hours on the rope',
    tierFull: 'Full day',
    tierFullNote: 'Full day, my gear',
    included: 'You run ground and haul. I bring climbing and rigging gear, fully insured.',
    qualsTitle: 'What you’re booking',
    quals: [
      '[X] years climbing professionally',
      'Fully insured — general liability',
      'Own saddle, ropes, and rigging gear',
      'Sectional takedowns, storm damage, rigging over structures',
      '[Certs / ISA — fill in or delete]',
    ],
    formTitle: 'Send me the job',
    fCompany: 'Company *',
    fContact: 'Your name *',
    fPhone: 'Phone',
    fEmail: 'Email',
    fLocation: 'Job location',
    fLocationPh: 'Town or address',
    fClimb: 'What’s the climb?',
    climbPick: 'Pick one',
    climbOpts: {
      sectional: 'Sectional removal',
      takedown: 'Full takedown',
      storm: 'Storm damage',
      rigging: 'Rigging-heavy / over structures',
      other: 'Something else',
    },
    fSize: 'Rough size',
    sizePick: 'Pick one',
    sizeOpts: { small: 'Under 40 ft', mid: '40–70 ft', big: '70+ ft / big wood' },
    fWhen: 'When?',
    fWhenPh: 'Date or “flexible”',
    fGround: 'Ground support',
    groundPick: 'Pick one',
    groundOpts: {
      crew: 'I have ground crew + chipper',
      climberOnly: 'Climber only, I handle the rest',
      unsure: 'Not sure yet',
    },
    detailsLabel: 'Anything else?',
    detailsPh: 'Access, power lines, crane, deadline — whatever I should know.',
    requiredNote: '* Company and your name, plus a phone or email so I can reach you.',
    submit: 'Send the job',
    submitting: 'Sending…',
    seHablaNote: 'Se habla español. Llame o escriba con cualquier pregunta.',
    ...
    errRate: 'Too many requests, slow down. Try again in a minute.',
    errMissing: 'Please give your company, your name, and a phone or email.',
    errSave: 'Something broke saving your request. Call or text instead and I’ll get you sorted.',
  },
...
const es: Dict = {
  ...
  contract: {
    ...
    metaDesc:
      '¿Necesita un escalador para una sección que su cuadrilla no alcanza? Escalo por contrato en Colorado Springs — remociones por secciones, daño por tormenta, desmontes con aparejo. Asegurado, equipo propio.',
    kicker: 'Para empresas de árboles',
    headTitle: 'Escalo por contrato',
    headLede:
      'Su cuadrilla, mis cuerdas. Resérveme para la sección que nadie en el suelo quiere — remociones por secciones, ramas quebradas por tormenta, aparejo sobre la casa.',
    bookLine: 'Llame o escriba para reservar un día:',
    ratesTitle: 'Tarifas por día',
    tierHalf: 'Medio día',
    tierHalfNote: 'Hasta ~4 horas en la cuerda',
    tierFull: 'Día completo',
    tierFullNote: 'Día completo, mi equipo',
    included:
      'Usted maneja el suelo y el acarreo. Yo traigo el equipo de escalada y aparejo, totalmente asegurado.',
    qualsTitle: 'Lo que está reservando',
    quals: [
      '[X] años escalando profesionalmente',
      'Totalmente asegurado — responsabilidad civil',
      'Arnés, cuerdas y equipo de aparejo propios',
      'Remociones por secciones, daño por tormenta, aparejo sobre estructuras',
      '[Certificaciones / ISA — complete o borre]',
    ],
    formTitle: 'Envíeme el trabajo',
    fCompany: 'Empresa *',
    fContact: 'Su nombre *',
    fPhone: 'Teléfono',
    fEmail: 'Correo',
    fLocation: 'Ubicación del trabajo',
    fLocationPh: 'Pueblo o dirección',
    fClimb: '¿Cuál es el trabajo de escalada?',
    climbPick: 'Elija una',
    climbOpts: {
      sectional: 'Remoción por secciones',
      takedown: 'Desmonte completo',
      storm: 'Daño por tormenta',
      rigging: 'Aparejo pesado / sobre estructuras',
      other: 'Otra cosa',
    },
    fSize: 'Tamaño aproximado',
    sizePick: 'Elija una',
    sizeOpts: { small: 'Menos de 40 pies', mid: '40 a 70 pies', big: 'Más de 70 pies / madera grande' },
    fWhen: '¿Cuándo?',
    fWhenPh: 'Fecha o “flexible”',
    fGround: 'Apoyo en el suelo',
    groundPick: 'Elija una',
    groundOpts: {
      crew: 'Tengo cuadrilla de suelo + astilladora',
      climberOnly: 'Solo escalador, yo me encargo del resto',
      unsure: 'Aún no estoy seguro',
    },
    detailsLabel: '¿Algo más?',
    detailsPh: 'Acceso, líneas eléctricas, grúa, fecha límite — lo que deba saber.',
    requiredNote: '* Empresa y su nombre, más un teléfono o correo para poder contactarlo.',
    ...
    errRate: 'Demasiadas solicitudes, despacio. Intente de nuevo en un minuto.',
    errMissing: 'Por favor dé su empresa, su nombre, y un teléfono o correo.',
    errSave: 'Algo falló al guardar su solicitud. Llame o escriba y lo resuelvo.',
  },
