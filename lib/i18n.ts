...
const en = {
  ...
  contract: {
    ...
    ratesTitle: 'Day rate',
    rateUnit: 'per day',
    included: 'I bring all climbing and rigging gear, fully insured. Send the details and I’ll get you a firm number.',
    ...
    fPhone: 'Phone',
    fEmail: 'Email',
    detailsLabel: 'What’s the job?',
    detailsPh: 'The tree, access, power lines, crane, deadline — whatever I should know.',
...
const es: Dict = {
  ...
  contract: {
    ...
    rateUnit: 'por día',
    included:
      'Traigo todo el equipo de escalada y aparejo, totalmente asegurado. Envíe los detalles y le doy un número firme.',
    ...
    fPhone: 'Teléfono',
    fEmail: 'Correo',
    detailsLabel: '¿Cuál es el trabajo?',
    detailsPh: 'El árbol, acceso, líneas eléctricas, grúa, fecha límite — lo que deba saber.',
