...
const en = {
  ...
  home: {
    ...
    services: [
      { title: 'Sectional takedowns and rigging', body: 'Big removals brought down in pieces, roped and lowered over the house, the fence, or the lines when there’s no room to fell it. Off your crew’s plate.' },
      { title: 'Storm work and the climb nobody wants', body: 'Broken tops, hung limbs, and leaners made safe up in the canopy. The technical piece past your team. I climb it, you run the ground.' },
    ],
    ...
    faqs: [
      ...
      { q: 'Do you climb the trees others find too dangerous or difficult?', a: 'Yes. The dangerous and difficult ones are the reason to bring in a climber. They need more time, more rigging, and more care to bring down clean, so they sit at the top of the day rate rather than the bottom. You get a straight number before I leave the ground.' },
  ...
  work: {
    ...
    cap4: 'Working across the canopy, tree to tree.',
    videoTitle: 'Watch a climb',
    videoCap: 'Real rope work, no edits.',
    videoCap2: 'Swinging tree to tree, high in the pines.',
  ...
  // the public "leave a review" form (/reviews/new). Copy matches the site voice.
  reviewForm: {
    metaTitle: 'Leave a review · Woodchuckers',
    pageTitle: 'Leave a review',
    formTitle: 'Leave a review',
    lead: 'Worked with me? Tell folks how it went — every review is read before it goes up.',
    fName: 'Your name',
    fRating: 'Your rating',
    starsAria: (n: number) => `${n} star${n === 1 ? '' : 's'}`,
    fTown: 'Town (optional)',
    townPh: 'Monument, Falcon, …',
    fReview: 'Your review',
    reviewPh: 'What was the job, and how did it go?',
    moderationNote: 'Reviews are checked before they appear — nothing posts automatically.',
    submit: 'Submit review',
    submitting: 'Sending…',
    thanksTitle: (name: string) => `Thanks, ${name}.`,
    thanksBody: 'Your review is in — I read each one before it goes up. Questions? Call',
    errRate: 'One moment — too many submissions just now. Try again in a minute.',
    errMissing: 'Please add your name and a few words of review.',
    errRating: 'Pick a star rating from 1 to 5.',
    errSave: "That didn't go through. Give it another try in a moment.",
  },
...
const es: Dict = {
  ...
  home: {
    ...
    services: [
      { title: 'Remociones por secciones y aparejo', body: 'Remociones grandes bajadas en piezas, con cuerda, sobre la casa, la cerca o los cables cuando no hay espacio para tumbarlo. Fuera del plato de su cuadrilla.' },
      { title: 'Trabajo de tormenta y la escalada que nadie quiere', body: 'Copas rotas, ramas atoradas e inclinados, asegurados arriba en la copa. La pieza técnica más allá de su equipo. Yo la escalo, usted maneja el suelo.' },
    ],
    ...
    faqs: [
      ...
      { q: '¿Escala los árboles que otros consideran demasiado peligrosos o difíciles?', a: 'Sí. Los peligrosos y difíciles son la razón para traer un escalador. Necesitan más tiempo, más aparejo y más cuidado para bajarlos limpio, así que quedan en la parte alta de la tarifa por día, no en la baja. Usted recibe un número claro antes de que yo deje el suelo.' },
  ...
  work: {
    ...
    cap4: 'Trabajando por la copa, de árbol a árbol.',
    videoTitle: 'Vea una escalada',
    videoCap: 'Trabajo real con cuerda, sin ediciones.',
    videoCap2: 'De árbol a árbol, en lo alto de los pinos.',
  ...
  reviewForm: {
    metaTitle: 'Dejar una reseña · Woodchuckers',
    pageTitle: 'Dejar una reseña',
    formTitle: 'Dejar una reseña',
    lead: '¿Trabajamos juntos? Cuente cómo le fue — cada reseña se revisa antes de publicarse.',
    fName: 'Su nombre',
    fRating: 'Su calificación',
    starsAria: (n: number) => `${n} estrella${n === 1 ? '' : 's'}`,
    fTown: 'Ciudad (opcional)',
    townPh: 'Monument, Falcon, …',
    fReview: 'Su reseña',
    reviewPh: '¿Cuál fue el trabajo y cómo salió?',
    moderationNote: 'Las reseñas se revisan antes de aparecer — nada se publica automáticamente.',
    submit: 'Enviar reseña',
    submitting: 'Enviando…',
    thanksTitle: (name: string) => `Gracias, ${name}.`,
    thanksBody: 'Su reseña llegó — leo cada una antes de publicarla. ¿Preguntas? Llame al',
    errRate: 'Un momento — demasiados envíos ahora mismo. Intente de nuevo en un minuto.',
    errMissing: 'Agregue su nombre y unas palabras de reseña.',
    errRating: 'Elija una calificación de 1 a 5 estrellas.',
    errSave: 'No se pudo enviar. Intente de nuevo en un momento.',
  },
